...
using PuzzleHen.CustomPlayerPref;
...
public class SPrefs
{
    ...
    {
        //PlayerPrefs.Save();
        SPrefsExampleUsage.Save();
    }

    public static void Load() => SPrefsExampleUsage.Load();
